...
public static class SeaOpticsTest
{
    ...
    public static string Run(out bool ok)
    {
        ...
        bool shoreContract = source.Contains("fwidth(edgeDepth) * SEA_SHORE_OPTICAL_MIN_PIXELS")
            ...
            && source.Contains("float nearSurfaceContact = 1.0 - smoothstep(2.0, 8.0, thickness);")
            && source.Contains("contactBand * nearSurfaceContact")
            && source.Contains("color = lerp(color, SampleSceneColor(screenUV)")
