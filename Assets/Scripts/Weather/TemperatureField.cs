...
public class TemperatureField : MonoBehaviour
{
    ...
    [Tooltip("Deniz seviyesindeki temel sıcaklık (°C). Donma seviyesinin nerede " +
             "olacağını bu belirler. −3 °C, 6.5 °C/km düşüşle deniz seviyesinin " +
             "462 metre ALTINDA sıfıra iner: dağın tamamı donma seviyesinin üstünde " +
             "kalır, yağış her kotta kar olarak düşer. Zemin (186 m) öğlen −2.6 °C, " +
             "fırtınada −5.8 °C; zirve −38 °C.")]
    [SerializeField] float seaLevelCelsius = -3f;
