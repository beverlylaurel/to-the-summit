...
## Kıyıda zebra deseni — kumsalda kontur çizgileri

**Sebep: karaya sabit bir sayı dolduruluyordu ve o sayı periyodik bir fonksiyona
giriyordu.** Seyahat alanı yalnız suda çözülüyor; ulaşılmayan teksellere "delik olmasın"
diye alandaki en büyük değer (263,5 s) yazılmıştı. Shader ise `frac(tau / Tp)` ile fazı
kuruyor: su çizgisinin bir yanında birkaç saniye, öbür yanında 263,5 s — tek tekselde
**26 tam çevrim**. Bilineer süzme onu kıyı boyunca yayınca kumsal zebra oldu.

Deniz seviyesine yakın düz kumluklarda etki büyüyor: komşu teksellerin bir kısmı su bir
kısmı kara olduğu için alan 0 ile 264 arasında gidip geliyor ve desen geniş bir alana
yayılıyor.

**Aynı ölçüm ikinci, daha büyük bir hatayı da açtı.** Cephe SU ÇİZGİSİNDEN başlatılıyordu,
yani `tau` orada tanım gereği 0 — bütün kıyı aynı fazdaydı. Alanın var oluş sebebi tam da
bunu kırmaktı. Dalga DERİNDEN gelir; hangi noktaya ne zaman vardığı koyu buruna göre
geciktiren şeydir.

**Düzeltme:**
- Cephe derin sudan başlıyor (`depth >= spectrumDepth` ve arazi kenarı), kıyıya doğru
  yürüyor.
- Kara, dokunduğu suyun değerini alıyor (sıfır maliyetli ikinci cephe). Su çizgisinde
  süreklilik var, karada faz birikmiyor.

**Ölçüm — öncesi/sonrası:**

| | önce | sonra |
|---|---|---|
| su çizgisinde `tau` | her yerde 0 | 105,9 – 449,6 s (medyan 193,6) |
| su çizgisini geçerken sıçrama | 0 → 263,5 s | 148,49 → 148,49 s |
| karada komşu farkı | — | 0,00 – 0,07 s |

## Devasa dalgalar kayboldu

Kıyı dalgası yüzeyi 10 metre derinliğe kadar devralıyordu — kıyıdan 170 metre. O bandın
tamamında FFT'nin dikeyi sıfırlanıp yerine **iki sinüs** geçiyordu; açık denizin zenginliği
o mesafede yok oluyordu.

**Yanlış soru sorulmuştu.** "Ne kadar derin" değil, "dalga burada derinlikle mi sınırlı".
Ölçüt kırılma indisi: `B = H / (gamma h)`. `B` 1'e vardığında dalganın şekli tabanın işi;
1'in çok altındaysa hâlâ spektrumun işi.

| U10 | Hs | devir başlıyor | kıyıdan |
|---|---|---|---|
| 0,5 | 0,74 m | 3,1 m | 53 m |
| 3 | 1,17 m | 4,5 m | 77 m |
| 8 | 2,31 m | 7,8 m | 134 m |
| 20 | 4,91 m | 14,2 m | 245 m |
